...
@property (weak, nonatomic) IBOutlet UILabel *lblPlateNumber;
@property (weak, nonatomic) IBOutlet UILabel *lblCarID;
@property (weak, nonatomic) IBOutlet UILabel *lblCarNum;
@property (weak, nonatomic) IBOutlet UILabel *lblCarType;
@property (weak, nonatomic) IBOutlet UILabel *lblRate;
@property (weak, nonatomic) IBOutlet UIButton *btnPromoCode;
