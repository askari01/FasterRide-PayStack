...
@property (weak, nonatomic) IBOutlet UIImageView *imgAlertBg;
...
@property (weak, nonatomic) IBOutlet UIButton *btnShedule;
...
@property (weak, nonatomic) IBOutlet UILabel *lblMakeRequest;
...
@property (weak, nonatomic) IBOutlet UILabel *lblETATitle;
@property (weak, nonatomic) IBOutlet UILabel *lblMinFare;
@property (weak, nonatomic) IBOutlet UILabel *lblEstimateTimeMessage;
@property (weak, nonatomic) IBOutlet UILabel *lblContactingNearByDriver;
