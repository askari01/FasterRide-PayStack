...
- (void)viewDidLoad
{
	...
	[self.imgAddPayment setBackgroundColor:DarkBtnColor];
	[self.btnAddPayment setBackgroundColor:LightBtnColor];
...
- (IBAction)addPaymentBtnPressed:(id)sender
{
    ...
    {
        [APPDELEGATE showToastMessage:NSLocalizedString(@"Invalid_Card", nil)];
        return;
    }
