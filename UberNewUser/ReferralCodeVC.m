...
- (void)viewDidLoad
{
	...
	[self.btnShare setBackgroundColor:LightBtnColor];
	[self.lblBgRefrelCode setBackgroundColor:RefrelCodeColor];
	[self.lblBgRefrelCredit setBackgroundColor:RefrelCreditColor];
...
-(void)SetLocalization
{
    ...
    self.lblReferralTitle.text = NSLocalizedString(@"Referral Title", nil);
    self.lblYourReferralCode.text = NSLocalizedString(@"Your Referral Code", nil);
    self.lblYourReferralCredit.text = NSLocalizedString(@"Your Referral Credit", nil);
    self.lblShareReferralMessage.text = NSLocalizedString(@"Share Referral Message", nil);
}
