...
NSString *const FILE_GET_ESTIMATE_FARE=@"geteta";
NSString *const FILE_GET_GOOGLE_KEYS=@"application/get_keys";
...
NSString *strForGooglePlusClientId;
NSString *strForGooglePlusClientSecret;
NSString *strForGoogleMapKey;
